...
-- -----------------------------------------------------
-- Table `books_schema`.`authors_favorite_books`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `books_schema`.`authors_favorite_books` (
  `book_id` INT NOT NULL,
  `author_id` INT NOT NULL,
  INDEX `fk_books_has_authors_authors1_idx` (`author_id` ASC) VISIBLE,
  INDEX `fk_books_has_authors_books1_idx` (`book_id` ASC) VISIBLE,
